...
urlpatterns = [
    ...
    path('projects/<int:project_id>/update/', views.EditProject.as_view(), name='project_update'),
    path('projects/<int:project_id>/delete/', views.DeleteProject.as_view(), name='project_delete'),
